...
3. While Lucian is at Firsthold, Korrath strikes Blackspire. **Morvath** — kept hidden since the Last Continental War, his survival known only to Vesper and Aldric — senses the threat to **Lirath (established here as his mate)** and breaks cover first, before Vesper can even reach Lirath. **Early plant already laid in Ch.63 ("Kindled"), kept deliberately minimal per author's direction:** a single brief beat — Ancalion's head turns once toward the deeper dark at the back of the cave (not sealed, just naturally far deeper than anyone has ever had reason to explore), some quiet deference passing through the bond, gone before Lucian can ask about it. Not lingered on or explained. Keep this thread dormant and unexplained until the actual reveal in the war arc.
