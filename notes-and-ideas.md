...
**Roderic POV chapter (planned, immediately after Ch.65 "Herald"):** Shows Roderic receiving reports that the Kaelarions/Caldarions already know about his buildup, and that Aldric has flown north — from his side, confirmation his hand has been shown. Because the leaked detail (which minor lords, how long) is specific enough to only plausibly have come from inside his own house, it should read as *obvious* to Roderic that Isolde is the source — not a mystery he has to solve, but a conclusion he reaches immediately and with real anger/betrayal, given his established pride and honor-bound temperament. Other Dravenhall family members (the cousins/retainers Isolde actually wrote to) could plausibly be identified too, not just Isolde herself — meaning this isn't a clean, contained leak but one that exposes real people to Roderic's retaliation. This creates a live danger thread for Isolde (and possibly named family contacts) heading into the war, separate from and in addition to Roderic's military response.
