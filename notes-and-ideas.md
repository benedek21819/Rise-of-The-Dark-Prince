...
3. While Lucian is at Firsthold, Korrath strikes Blackspire. **Morvath** — kept hidden since the Last Continental War, his survival known only to Vesper and Aldric — senses the threat to **Lirath (established here as his mate)** and breaks cover first, before Vesper can even reach Lirath. **Early plant already laid in Ch.63 ("Kindled"):** during a quiet Lucian/Ancalion scene in the dragon cave, Ancalion shows careful, deferential stillness toward a sealed passage deeper in the mountain, and Lucian half-hears an unplaceable resonance — noticed, mildly curious, not investigated, since Lucian has no idea Morvath exists and reads it as one more of the house's staged secrets. Keep this thread dormant and unexplained until the actual reveal in the war arc.
