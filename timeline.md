...
- Once it becomes clear the dragon has survived, Vesper tells Aldric personally rather than concealing it from the crown outright. The two young men, each newly carrying the weight of their own house, decide together that revealing it would serve no one given the circumstances — Caldarion too weakened to defend an illegal asset from scrutiny, Kaelarion's own throne too dependent on Caldarion's strength to want that strength publicly diminished. The secret becomes a shared one between the two houses' heads rather than a one-sided deception, known only to Aldric and Vesper personally.
