...
**The one thing it does not do is hide anything from sight.** Anyone looking at Korrath saw a dragon. The cloud defeated the eyes; the sphere defeated everything else; **neither alone would have been enough.**

**What still betrays it — you cannot hide the fact that something was hidden.** The sphere leaves no signature, because a signature is exactly what it suppresses. What it leaves is an **absence**: a patch of Veil with no texture in it, smooth where the world is normally noisy, which anyone reading for it afterward will find and be unable to explain any other way. That is the thread that reaches Myrath, and it is corroboration rather than discovery, since Roderic hands Caldarion the object himself in Ch.73.
