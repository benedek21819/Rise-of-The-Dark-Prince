...
The story is set on a single continent unified under **one kingdom**. The kingdom is divided into **9 Duchies**. Each duchy is ruled by either one of the **8 Great Houses** or the **Royal Family** itself.
