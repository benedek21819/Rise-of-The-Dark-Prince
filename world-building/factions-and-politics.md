...
**How the sphere actually works — passive, and narrow.** It has no trigger and is never switched on. It **continuously covers the aura of whatever is near it** — the presence dragons feel each other by — for as long as it is carried, and it has been doing so from the day it was fixed to Korrath's harness. It is **not invisibility**: it hides nothing whatsoever from eyes, and anyone looking at Korrath sees a dragon. The cloud defeated the eyes; the sphere defeated the sense; **neither alone would have been enough.**
