...
## Deepcoal
A dense, unusually hot-burning coal mined from deep seams within House Kestrion's territory.

- **Where it's found:** Concentrated in deep mine seams within Kestrion's own lands — not exclusive in the absolute sense, but Kestrion's mining infrastructure and expertise make them the dominant source by a wide margin.
...
- **Significance:** The literal engine behind Kestrion's specialty — heavy industry, weapons manufacturing, siege engines, and mass military production owe as much to Deepcoal as to Kestrion's own skill or workforce. It is what lets them out-produce every other house's forges in volume, even without Cold Silver, a dragon, or Caldarion's elite training.
- **Vulnerability:** Because Kestrion's industrial dominance rests on a single fuel source rather than several independent advantages, any serious disruption to Deepcoal's supply (a mine collapse, exhausted seams, denied access) would threaten the house's entire economic and military identity at once — a structural weakness Cold Silver's owner does not share to the same degree.
- **The current crisis (as of the Great Houses' Convocation, Chapter 49 onward):** The deepest Deepcoal seams have begun failing in ways no engineer or mining tradition has an explanation for. Unpredictable ignitions — flare-ups with no identifiable spark, some catastrophic, leaving scorch patterns that don't behave like ordinary fire — have killed miners in growing numbers over the past year. Sections of shaft that have been structurally sound for generations are collapsing without geological cause. As a direct, practical consequence, miners are increasingly refusing to work the deepest sections regardless of pay, crippling production. Kestrion has found no mundane cause and no mundane fix. This is the house's own concrete, personal stake in the Convocation's Veil-anomaly agenda — not abstract unease like most other houses, but an active, escalating catastrophe threatening their entire economic and military identity at once. Kestrion does not yet suspect any connection to House Caldarion specifically; their attention at the Convocation is fixed on finding the actual cause, most plausibly through House Myrath's scholarship, not on any rival house's old secrets.
