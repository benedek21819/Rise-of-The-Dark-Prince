...
- **Extreme rarity and cost.** Proper use requires immense Will and control; misuse can backfire catastrophically on the user.
- **One Commandment per person — used without limit.** A person who carries the gift holds **exactly one specific Commandment** (a single compulsion: *flee*, *fall*, *kneel*), and that one word is theirs for life. They may speak it **as often as they like**; the power is not expendable. What defines and constrains such a person is not scarcity of use but the fact that they will only ever have that one word, whatever situation they find themselves in.
- **Sealed Commandments are a different thing, and those are single-use.** A Commandment can be **sealed into an artifact or relic by its holder**, so that someone without the gift can speak it once. What is consumed is the seal, not the power — the original holder is unaffected and can go on using their Commandment freely. House Dravenhall's relic is exactly this: one Commandment, placed into an object long ago by someone else, available to Roderic for a single deliberate use.
- **The gift has appeared in House Caldarion before**, rarely, surfacing down a long line and vanishing again for generations. The record of it sits in the Vaults with the rest of the house's deepest history, so **Vesper learned it at succession, not in childhood** — the Vaults open to the head of the house and no one else. That is why he recognizes a Commandment on sight in Ch.71 without ever having held one, and it should be conveyed in as few words as possible: he knows what it is; he does not explain it to himself mid-battle. He does not carry the gift, and **Lucian's latent capacity is not known to Vesper, to Lucian, or to anyone.**
...
The mastery-tier expression of the Still Blade's own Weight principle — no longer a metaphor for imposing presence, but presence made physically real. Within Vesper's domain, everything and everyone besides himself becomes measurably, dramatically heavier: weapons grow difficult to lift, footsteps sink, breath labors, movement slows toward a crawl. Vesper himself can move the opposite way within the same field — lighter, freer, unnaturally at ease while everything around him is crushed toward stillness.

- **There is nothing to see.** This is important and easy to get wrong. The Weight has **no visible manifestation whatsoever** — no light, no distortion, no darkening, no sound, no boundary anyone can point at. It is a manipulation of weight and nothing else. From outside the radius there is literally nothing to observe except its effects on bodies, and at any distance those read as men and animals simply struggling. **Only those inside the field know it exists**, and they know it absolutely, from the inside, the instant it closes on them. A witness on a wall a mile away sees a fight going strangely; a man inside it knows exactly what has been done to him.

- **Nature:** Raw and overwhelming rather than subtle — a ruler's tool, not a duelist's. Where Lucian's Absence denies information with precision, Vesper's Weight denies **motion**, across a whole volume at once.
- **Control — selective, and variable by will.** The field is not indiscriminate. Vesper **chooses who it touches**, and can exclude allies entirely, so his own people move freely through ground that is crushing everything else. He can also **modulate the pressure at will**, from a faint drag to something that pins a man where he stands. Holding the field selectively demands more concentration than simply flooding an area with it, and sustaining either takes a real physical toll.
- **Limits:** It has a **finite radius** and does nothing beyond it — step outside the field and it is simply not there, which is the single most important constraint on it in a fight. Against something as powerful as a dragon in flight it does not immobilize; at full pressure it makes even a creature like **Korrath significantly sluggish** for as long as he stays in range, which is enough to turn a losing fight into an even one and nothing like enough to win one outright.
- **Cost and exposure:** the exposure is **not visual — it is testimonial and residual.** Nobody watching from a distance learns anything. But anyone caught inside the field knows past all argument that they have just been subjected to something no ordinary man can do, and if they survive they can say so; and the working leaves a correspondingly heavy trace in the Veil, far more detectable than ordinary Veilweaving, available to anyone who was reading for it or who comes looking afterward. Using it in front of a witness who lives is therefore closer to a public declaration than a private advantage. This is precisely why Vesper almost never uses it, even though he has carried the capability for decades: it announces something every single time, and a house built on controlled information cannot afford many announcements. **The practical consequence in the war is narrow and useful:** his own household and the men on the walls learn nothing at all, and the people who learn everything are the ones he is using it against.
...
- **The Black Star Artifacts**: Three objects forged from the same fragment of the Eternal Current that crossed over at the First Eclipse — the **Dark Throne** (seat and seal), the sword **Eclipse** (symbol of imperial authority), and the **Caldarion signet ring** (proof of authenticity). See history-and-lore.md, "The First Eclipse," for full detail on all three.
- **The Caldarion Signet Ring**: Set with the Black Sun sigil. Any wax or ink impression made with it carries a faint, consistent trace of the Primordial Darkness regardless of what is being sealed — a signature no forger can reproduce, which is what makes an imperial Caldarion decree provable rather than merely claimed. It left Arcanor with the family at the exile and has never been separated from the direct line since. It is the physical mark of headship, passed father to son together with the house's deepest secrets, and the only key to the Imperial Vault sealed beneath the old capital of Arcanor since the exile. Currently held by Vesper Caldarion, worn as a concealed pendant beneath his clothing rather than displayed.
...
- **Korrath (~120 yrs, faster than average pace): roughly the same size as Lirath, despite being fifty years younger.** Like Ancalion he is simply a fast-growing individual — dragons are not bred to order and no house has ever managed to produce one to specification, so this is luck, not husbandry. **Do not write him as visibly larger than Lirath** — the difference is build and disposition, not scale: she is long, he is thick through the chest and shoulders, and he has fifty years less age with none of the size penalty for it. **And do not explain her disadvantage by age.** At ~170 of a 300–350-year lifespan she is mid-life, not declining. What makes her overmatched is exactly what Ch.67 says on the page: Korrath has killed dragons in a war and enjoyed it, and she has never in her life gone looking for a fight she could walk away from.
- **Kaldross (dead; killed in the Last Continental War ~26 years ago): bright red female, Korrath's mother, and considerably larger than him** — she was the older animal by a wide margin. Ridden by Lord Bertran Dravenhall; killed with him by Morvath in the duel over the coast that also killed Ravorn Caldarion. Her existence is why House Dravenhall fielded two dragons in one generation, which was luck rather than husbandry.
...
- **Temperament and aggression** — some dragons (Korrath) are naturally aggressive and thrive in direct confrontation; others (Solara, Lirath) are calmer and less inclined to press an advantage even when they have one. This is individual disposition, not something a house can breed for.
...
- **Void-touched flame.** His black flame is not simply a color variant of ordinary dragonfire. It draws on the same darker current of the Veil that House Caldarion's Shadow/Void magic draws on — resistant to being countered by conventional means, and capable of degrading wards or Veil-based defenses rather than only burning flesh and stone.
  - **How it behaves, for prose consistency:** it gives off no light (Ch.68 — "it did not light what it touched, it took the light out"), and it does not char. It **takes the color and the substance out** of what it touches, leaving it grey and dead-looking. Against massed men in the open it is annihilating.
  - **And it is still bounded by the animal producing it.** More destructive than ordinary dragonfire is not the same as unlimited: a young dragon carries only so much fire in a day, it weakens as he tires, and against the sheer mass of a mature dragon it wounds badly without killing. **This is why Ch.70–72 work at all** — Ancalion visibly damages Korrath through the whole engagement and cannot finish him, and the kill when it comes is jaws at the throat, not flame.
- **Exceptional healing.** Ancalion recovers from injury markedly faster than an ordinary dragon — part of the same cluster of unusual traits as his growth rate and his black flame, and presumably traceable to his parent's closeness to the Primordial Darkness. It is **fast, not miraculous**: deep wounds still take weeks and still hurt, and he can be put out of the sky for a season. He simply comes back from things on a timescale that surprises people who know dragons. **After the Dravenhall war he recovers fully**, torn wing and opened flank and broken foreleg together.
...
**Reality:**
House Caldarion secretly owns a third dragon — the very large male **Morvath**. 

**Ancalion’s Origin:**
Ancalion’s egg was **not** laid by Lirath. The egg was laid around Imperial Year 800 by a secret Caldarion dragon that was never publicly acknowledged. This dragon was unusually close to the Primordial Darkness — more so than ordinary dragons — and its existence was already a closely guarded secret within the highest levels of the house.

When the egg appeared, it intensified existing fear and political pressure against House Caldarion. Combined with the misinterpreted prophecy, the appearance of the egg became one of the catalysts that contributed to the decision to force the main line of the house into exile.

Rather than risk the egg falling into anyone else’s hands, the Caldarions took it with them when they left Arcanor in approximately Year 812. The egg remained dormant for a very long time and only hatched much later, bonding with Lucian Caldarion through the cradling ritual.

The exact fate of the parent dragon after laying the egg is currently unknown and remains one of the deeper secrets of the house.

**Ancalion:**
Ancalion is the youngest publicly known dragon on the continent. He was cradled with Lucian since birth. Cradling dragon eggs with newborns significantly increases the chance of successful hatching and creates a deeper, more effective bond. Ancalion is male, has a very large wingspan relative to his body (making him exceptionally fast), completely black scales, pitch black flames, and deep dark purple eyes similar to Lucian’s. His connection to the Primordial Darkness through his unknown parent may explain some of his unusual traits.
...
**Her condition after the Dravenhall war:** she survives the fall onto the eastern scree and **recovers**, slowly and incompletely. **Whether she will ever fly again is not known and should stay unknown** — not by anyone in the house, not by the reader, and not in the bible. Play it as an open question that outlasts the arc. She is the house's only female and therefore the whole of Caldarion's dragon future (see "Reproduction" above), which is what makes the uncertainty expensive rather than merely sad.

**She was already Vesper's at the time** — bonded to him since boyhood — and the two facts were one decision: Ravorn took Morvath south and left his nineteen-year-old son to **hold Blackspire with Lirath**. A real command, genuinely necessary, and exclusion all the same (see `history-and-lore.md`).
...
**Morvath:**
**Physical condition, settled:** he is **fully healed** from the wounds of the Last Continental War — twenty-six years is a long time — and breaking cover in the Dravenhall war costs him nothing lasting. He is **old and slow to start**, which is a matter of age rather than injury, and once moving he is simply the largest and most dangerous thing on the continent. **Do not write this appearance as a final effort or a sacrifice.** He is needed intact for Arcanor.
...
Morvath currently has **no bonded rider**. His last rider was Lucian Caldarion’s grandfather **Ravorn**, who died near the end of the **Last Continental War** in a dragon duel over the coast against **Lord Bertran Dravenhall** on the elder Dravenhall dragon **Kaldross** — a bright red female, larger than Korrath, and Korrath's mother. Morvath killed them both and was terribly hurt doing it, then went into the sea with the already-wounded Ravorn on his back. **Ravorn drowned; no body was ever recovered.** Morvath barely reached the shore alive. Witnesses on both sides saw two dragons fall and neither rise, and reported mutual destruction in good faith — which is why the belief that Morvath died has held for twenty-six years (see `history-and-lore.md`, "How Ravorn died — the duel over the water"). Publicly, it is believed that Morvath died in battle alongside his rider. In reality, he survived and has been kept hidden by House Caldarion as one of their most powerful secret weapons.

**Korrath did not kill Ravorn.** Keep this straight in prose: Vesper is not carrying a blood grudge against the dragon over his mountain, and Morvath's emergence in the Dravenhall war has exactly one cause — Lirath's will overridden by a Commandment.
