...
**Note:** Chapter 50 ("Debt") resolves the mole hunt opened in Chapter 46. The leak is **Serris, Steward of Blackspire** — coerced via his son's debt to a Dravenhall-linked network in Firsthold, escalating until he gave up the Corvane parley's route (Ch.42). Vesper (not Lucian, deliberately — see Ch.43's parallel) delivers judgment personally: Serris is permanently exiled from Blackspire's service, spared execution given the coercion, while Vesper has the son quietly extracted from Dravenhall's leverage — removing the vulnerability rather than just punishing the man. Serris has left the household as of this chapter; see `characters/Blackspire_Staff.md`, which needs updating to reflect this. The mole thread is now closed.
